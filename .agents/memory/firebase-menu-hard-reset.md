...
The canonical menu purge must be isolated from running or stale clients. A client running an older Firebase sync can recreate deprecated top-level menu nodes immediately after DELETE when its listener sees an empty snapshot.
